...
- **Prerequisites**: Array of strings (required knowledge - basic ROS 2 understanding)
- **Chapters**: Array of Chapter references
- **Relationships**: Contains multiple Chapters

### Chapter
- **Title**: String (e.g., "Physics Simulation with Gazebo")
...
- **Code**: String (actual code/configuration content)
...
### SimulationConcept
- **Name**: String (e.g., "Digital Twin", "Physics Simulation", "Sensor Fusion")
- **Definition**: String (clear definition of the concept)
- **Applications**: Array of strings (how the concept is used)
...
- Title must be 5-100 characters
- Language must be a supported syntax highlighting language or configuration format
- Code must be 10-5000 characters
- Must belong to exactly one chapter
- Must be executable or represent a real configuration
...
3. Content written for each Chapter with concepts and examples
...
- Chapter → CodeExamples, Diagrams, SimulationConcepts (children)
- SimulationConcept → RelatedConcepts (connections across chapters)
- Navigation follows the same hierarchy for user experience
- Cross-chapter references are handled through concept connections